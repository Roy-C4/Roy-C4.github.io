...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Degree Section Dropdown Toggle
        if ($('.degree-header').length > 0) {
            $('.degree-header').on('click', function () {
                var $btn = $(this).find('.degree-toggle-btn');
                var $content = $(this).next('.degree-content');
